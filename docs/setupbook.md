# Track Manager Setupbook

How to get the Track Manager up and running locally with Docker Desktop.
...
# Set a stable project name to avoid Docker conflicts
...
1. The Track Manager should open automatically in your browser
...
If you get errors about container names already in use, ensure you've set a stable `ETFS_PROJECT_NAME` in `.env.local`.
